...
def new_prepare_data(img_rows=32, img_cols=32, color_type=3, only_val=False, data_augmentation=False, print_step=True):    
    ...
    train=['bamboo_1', 'bandage_1']#, 'cave_2', 'market_2', 'market_6', 'shaman_2', 'sleeping_1', 'temple_2'] # 440
    val=['bamboo_2', 'bandage_2']#, 'cave_4', 'market_5', 'mountain_1', 'shaman_3', 'sleeping_2', 'temple_3'] # 450
...
if __name__ == '__main__':
    ...
    X, y, X_val, y_val, Xa, ya, Xa_val, ya_val = new_prepare_data(img_rows, img_cols, color_type, False, data_augmentation, True)
    '''
    save_img(170, 'o', X, y)
