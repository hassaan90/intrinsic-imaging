...
crop_size_train              = (400, 400)      # Crop size during training (Height, Width) or None
crop_size_valid              = None            # Crop size during validation
crop_size_test               = None            # Crop size during testing
resize_train                 = (512, 1024)      # Resize the image during training (Height, Width) or None
...
LRScheduler_M                = 50000            # Number of iterations/epochs expected until convergence
