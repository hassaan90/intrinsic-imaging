...
def build_densenet(img_dim, nb_classes,  weight_decay=1E-4, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1,
                     bottleneck=False, reduction=0.0, dropout_rate=None, verbose=True):
...
if __name__ == '__main__':
    model = build_densenet(img_dim=(3, 32, 32), nb_classes=10, weight_decay=1E-4, depth=40, growth_rate=12, bottleneck=True, reduction=0.5)
